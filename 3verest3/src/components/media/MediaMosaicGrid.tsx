  ...
  const mediaCards: MediaCard[] = [
    {
      ...
      summary: 'Chicago, RSNA 2025. 3verest announces the 3verest Imaging Platform (3IP), the world\'s first sovereign, intelligent, and natively interoperable foundation for medical imaging innovation.',
