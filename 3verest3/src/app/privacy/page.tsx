    ...
    <div className="min-h-screen bg-[#F8FAF9] dark:bg-[#0A0A0A] transition-colors duration-300">
      ...
      <section className="py-12 px-6">
        <motion.div
          ...
          className="max-w-4xl mx-auto prose prose-lg dark:prose-invert prose-headings:font-light prose-headings:text-gray-900 dark:prose-headings:text-white prose-p:text-gray-700 dark:prose-p:text-white/90 prose-li:text-gray-700 dark:prose-li:text-white/90 prose-strong:text-gray-900 dark:prose-strong:text-white prose-a:text-[#00D6A3]"
        >
